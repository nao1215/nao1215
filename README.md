...
| [sqly](https://github.com/nao1215/sqly) | Go | 147 | Execute SQL against CSV, TSV, LTSV, JSON, JSONL, Parquet, Excel, ACH, and Fedwire files from the shell. |
...
| [qrkit](https://github.com/nao1215/qrkit) | Gleam | 8 | Pure Gleam QR code generator with terminal, SVG, and PNG rendering. |
...
| [gup](https://github.com/nao1215/gup) | Go | 589 | Fast manager for Go-installed binaries in $GOBIN: update, export/import, and migrate toolsets across machines |
...
| [career](https://github.com/nao1215/career) | Go | 3 | Generate a Japanese 履歴書 / 職務経歴書 and an English CV as PDF from a single YAML file. |
| [truss](https://github.com/nao1215/truss) | Rust | 7 | Rust image toolkit for CLI, HTTP, and WASM with signed URLs, SSRF protection, and AVIF, WebP, and SVG support. |
